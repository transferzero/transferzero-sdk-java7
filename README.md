...
```groovy
compile "com.transferzero.sdk:transferzero-sdk-java7:1.0.0"
```
...
* `target/transferzero-sdk-java7-1.0.0.jar`
* `target/lib/*.jar`
...
*TransactionsApi* | [**createAndFundTransactions**](docs/TransactionsApi.md#createAndFundTransactions) | **POST** /transactions/create_and_fund | Creates and funds a new transaction
