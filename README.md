...
<dependency>
  ...
  <version>1.36.3-SNAPSHOT</version>
  <scope>compile</scope>
</dependency>
```
...
```groovy
compile "com.transferzero.sdk:transferzero-sdk-java7:1.36.3-SNAPSHOT"
```
...
* `target/transferzero-sdk-java7-1.36.3-SNAPSHOT.jar`
* `target/lib/*.jar`
...
## Documentation for Models
 ...
 - [PayoutMethodDetailsEGPBank](docs/PayoutMethodDetailsEGPBank.md)
