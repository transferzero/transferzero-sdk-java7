...
public class RecipientStateReasonDetails {
   ...
   * @return code
  **/
  @ApiModelProperty(example = "311", value = "Status code of failed transaction")
   ...
   * @return category
  **/
  @ApiModelProperty(example = "temporary_error", value = "Main category of error, it could be paid, unknown, pickupable, temporary_error, recipient_error, sender_error")
  ...
  **/
   ...
   * @return description
  **/
  @ApiModelProperty(example = "The central switch is not accepting transfers at the moment. We will retry the transaction. You can also edit or cancel this transaction.", value = "Public, human readable, detailed error message")
